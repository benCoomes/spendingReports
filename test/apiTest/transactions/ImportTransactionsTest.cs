...
namespace Coomes.SpendingReports.ApiTest.Transactions
{
    ...
    public class ImportTransactionsTest
    {
        ...
        public async Task GetTransactions_ReturnsAllTransactions()
        {
            ...
            var importTransactions = new ImportTransactions(testData);
            
            // when 
            await importTransactions.Execute(expectedTransactions);
            var actualTransactions = await testData.GetAll();
